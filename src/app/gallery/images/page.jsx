  ...
  return (
    <div className="bg-[#D4FFFD] w-screen overflow-x-hidden text-black">
      ...
      <div className="p-5 rounded-2xl flex justify-center mt-5 gap-5 bg-white/80 backdrop-sepia-0 max-w-[80vw] 2xl:max-w-[40vw] mx-auto">
        <button className="bg-white hover:bg-gray-100 text-black font-semibold py-2 px-4 border border-gray-400 rounded">
        ...
        <button
          onClick={() => (window.location.href = "/gallery/videos")}

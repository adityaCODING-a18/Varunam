    ...
    return (
        <>
            ...
            <div className='flex justify-around'>
                <div>
                    <p className='text-center font-[poppins] text-sm text-gray-800'>Tools⚙️ to Upload Content to Varunam</p>
                    <div className='mx-auto flex flex-col items-center justify-center mt-4 mb-4 gap-4 bg-white p-5 rounded-xl shadow-md w-full max-w-md min-w-[40vw]'>
                        ...
                        <div className="m-2">
                            <button className='flex items-center gap-2' onClick={() => { window.location.href = `/dashboard/aiArticle?author=${Props.author}` }}>
                                <LuBrainCircuit className='size-9' />
                                <p>Ai powered Article Generator and Uploader</p>
                            </button>
                        </div>
                    </div>
                </div>
                <div>
                    <p className='text-center font-[poppins] text-sm text-gray-800'>Tools⚙️ to Delete 🗑️ Content from Varunam</p>
                    <div className='mx-auto flex flex-col items-center justify-center mt-4 mb-4 gap-4 bg-white p-5 rounded-xl shadow-md w-full max-w-md min-w-[40vw]'>
                        <p className='text-center font-[poppins] text-sm text-gray-800'>To Delete Image or Video from Varunam you must have caption of that content and to Delete an Article you must have title of that article.</p>
                        <div className="m-2">
                            <button className='flex items-center gap-2' onClick={() => { window.location.href = `/dashboard/DeleteContent?author=${Props.author}` }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-9">
                                    <path fillRule="evenodd" d="M1.5 6a2.25 2.25 0 0 1 2.25-2.25h16.5A2.25 2.25 0 0 1 22.5 6v12a2.25 2.25 0 0 1-2.25 2.25H3.75A2.25 2.25 0 0 1 1.5 18V6ZM3 16.06V18c0 .414.336.75.75.75h16.5A.75.75 0 0 0 21 18v-1.94l-2.69-2.689a1.5 1.5 0 0 0-2.12 0l-.88.879.97.97a.75.75 0 1 1-1.06 1.06l-5.16-5.159a1.5 1.5 0 0 0-2.12 0L3 16.061Zm10.125-7.81a1.125 1.125 0 1 1 2.25 0 1.125 1.125 0 0 1-2.25 0Z" clipRule="evenodd" />
                                </svg>
                                <p>Delete Photo</p>
